...
public class AMapBaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    public AMapBaseActivity() {
        mEndLatlng = new NaviLatLng(PubFunction.marker[0], PubFunction.marker[1]);
        mStartLatlng = new NaviLatLng(PubFunction.local[0], PubFunction.local[1]);
    }
...
//        Toast.makeText(this, "errorInfo：" + errorInfo + ",Message：" + ErrorInfo.getError(errorInfo), Toast.LENGTH_LONG).show();
        Toast.makeText(this, "路线计算失败，超出可规划的距离", Toast.LENGTH_SHORT).show();
    }
